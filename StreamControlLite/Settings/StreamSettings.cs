...
namespace StreamControlLite.Settings
{
    public static class StreamSettings
    {
        ...
        public static String WrapInput(String input) => $"{PreInputSettings} {input} {PostInputSettings} tcp://127.0.0.1:5051";
        ...
        public static String PostInputSettings = $" -c:v h264" +
                                              $" -bf 2" +
                                              $" -b:v 4300k" +
                                              $" -maxrate:v 4300k" +
                                              $" -bufsize:v 4300k" +
